...
and see how the performance of a model changes.""")
	...
	default_feature_cols = [df0.columns[1]]
	feature_cols = sel_col.multiselect('Select the columns to use as input features', df0.columns.tolist(), default=default_feature_cols)
